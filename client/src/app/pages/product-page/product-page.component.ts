...
export class ProductPageComponent implements OnInit {
  ...
  products: Product[] = [
    { name: 'Корпус Coguar Duoface', price: 11000, rating: 3, warranty: 10, manufacturer: 'Coguar', img: 'img-devices/image1.png', description: 'Среднеразмерный корпус Cougar Duoface Pro RGB White белого цвета и ARGB-подсветкой.  Среднеразмерный корпус Cougar Duoface Pro RGB White белого цвета и ARGB-подсветкой. Среднеразмерный корпус Cougar Duoface Pro RGB White белого цвета и ARGB-подсветкой. Среднеразмерный корпус Cougar Duoface Pro RGB White белого цвета и ARGB-подсветкой. Среднеразмерный корпус Cougar Duoface Pro RGB White белого цвета и ARGB-подсветкой. Среднеразмерный корпус Cougar Duoface Pro RGB White белого цвета и ARGB-подсветкой. Среднеразмерный корпус Cougar Duoface Pro RGB White белого цвета и ARGB-подсветкой. Среднеразмерный корпус Cougar Duoface Pro RGB White белого цвета и ARGB-подсветкой. Среднеразмерный корпус Cougar Duoface Pro RGB White белого цвета и ARGB-подсветкой. Среднеразмерный корпус Cougar Duoface Pro RGB White белого цвета и ARGB-подсветкой. Среднеразмерный корпус Cougar Duoface Pro RGB White белого цвета и ARGB-подсветкой. Среднеразмерный корпус Cougar Duoface Pro RGB White белого цвета и ARGB-подсветкой. Среднеразмерный корпус Cougar Duoface Pro RGB White белого цвета и ARGB-подсветкой. Среднеразмерный корпус Cougar Duoface Pro RGB White белого цвета и ARGB-подсветкой. ' },
 ...
 onProductSelected(product: Product) {
  ...
  this.openTheDoor = true;  // Открыть модальное окно
}
